...
import hr.base.IntSinglyLinkedLists;
...
public class App extends AbstractChallengeApp {
	...
	public void solve() throws Exception {
		Iterator<Integer> it = new MyIterator(IntSinglyLinkedLists.toList(array));
		...
		for (;;) {
			...
			if ("new".equals(cmd)) {
				it = new MyIterator(IntSinglyLinkedLists.toList(array));
